...
(function() {
  ...
  window.Vibrant = Vibrant = (function() {
    ...
    Vibrant.prototype.fromImageData =  function (imageData, colorCount, quality) {
        this.swatches = bind(this.swatches, this);
        var a, allPixels, b, cmap, g, i, image, offset, pixelCount, pixels, r;
        ...
        try {
          ...
          pixelCount = imageData.data.length; // image.getPixelCount();
          allPixels = [];
          i = 0;
          while (i < pixelCount) {
            offset = i * 4;
      ...
      Vibrant.prototype.fromSourceImage =  function (sourceImage, colorCount, quality) {
      this.swatches = bind(this.swatches, this);
